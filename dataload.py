...
db_password = os.environ.get('newpassword')  # Set to your own password
engine = create_engine('postgresql://postgres:{}@localhost/stockdata'.format(db_password)) # choose database
...
def create_prices_table(symbol):
    ...
    # Write the data into the database, with table named daily_prices.
